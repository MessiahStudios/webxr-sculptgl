...
**SPACE** moves the sculpture in the *room* (scale, distance, turntable) — not mesh Transform. The dock floats above the left grip and faces your headset. **Y** on SPACE re-seats clay in front of your headset (works for any guardian size).  
