var TR = {
  ...
  cameraHowToDocsTitle: 'How-to docs (WIP)',
  cameraDockUIExportAll: 'Export WebXR menu pack',
  cameraDesktopUIExportAll: 'Export desktop menu pack',
  cameraDockUIHint: 'Docs only — not in the headset product menu',
  cameraRecordTitle: 'Record',
  cameraRecordFps: 'FPS',
  cameraRecordQuality: 'Size',
  cameraRecordQualitySmall: '720p',
  cameraRecordQualityBalanced: '900p',
  cameraRecordQualityHigh: '1080p',
  cameraRecordStart: 'Start record',
  cameraRecordStop: 'Stop record',
  cameraRecordIdle: 'Status: idle',
  cameraRecordActive: 'Status: RECORDING…',
  cameraSpeed: 'Move speed',
  ...
  fileExportSGL: 'Save .sgl — full project',
  fileExportOBJ: 'Save .obj — geo + UVs',
  fileExportOBJMaps: 'Save .obj + maps (zip)',
  fileExportGLB: 'Save .glb — geo + PBR maps',
  fileExportPLY: 'Save .ply — geo ± color',
  fileExportSTL: 'Save .stl — geo only',
  fileExportHint: 'Formats only carry what they allow. GLB bakes vertex paint to maps when UVs exist.',
  ...
  sculptDrag: 'Drag',
  sculptPaint: 'Paint',
  sculptSoften: 'Soften (blend colors)',
  sculptPaintModeTitle: 'Paint tools',
  sculptPaintModePaint: 'Paint',
  sculptPaintModeSoften: 'Blend colors',
  ...
  sculptAlphaAngleReset: '0°',
  sculptAlphaAngleQuarter: '90°',
  ...
  sculptPaintShaderHint: 'Matcap / Flat show paint as color. PBR uses metal/rough — clay-friendly values auto-set (edit freely below).',
  sculptPaintIdealsApplied: 'Paint: clay-friendly roughness/metallic applied (editable)',
